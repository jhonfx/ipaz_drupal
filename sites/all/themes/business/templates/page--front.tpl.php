        ...
        <div class="main_view">
            <div class="window">
                <div class="image_reel">
                    <a href="#"><img src="<?php print base_path() . drupal_get_path('theme', 'business') . '/images/paz1.png'; ?>"></a>
                    <a href="#"><img src="<?php print base_path() . drupal_get_path('theme', 'business') . '/images/paz2.png'; ?>"></a>
                    <a href="#"><img src="<?php print base_path() . drupal_get_path('theme', 'business') . '/images/paz3.png'; ?>"></a>
                    <a href="#"><img src="<?php print base_path() . drupal_get_path('theme', 'business') . '/images/paz4.png'; ?>"></a>
                    <a href="#"><img src="<?php print base_path() . drupal_get_path('theme', 'business') . '/images/paz5.png'; ?>"></a>
                    
                    
                </div>
                <div class="descriptions">
                    <div class="desc" style="display: none;">Estampas Religiosas</div>
                    <div class="desc" style="display: none;">Cuadros Religiosos</div>
                    <div class="desc" style="display: none;">Folletos y Libros Religiosos</div>
                    <div class="desc" style="display: none;">Imagenes tamaño carta</div>
                    <div class="desc" style="display: none;">Rosarios y Escapularios</div>
